...
from nuzlocke_tool.constants import (
    ...
    LABEL_DECISION_GAME_CORNER,
    LABEL_DECISION_MAGIKARP,
    LABEL_DECISION_ROUTE12_ENCOUNTER,
    LABEL_DECISION_ROUTE16_ENCOUNTER,
...
class RandomDecisionToolWidget(QWidget):
    ...
    def _generate_decision_name(decision_key: str) -> str:
        statements = {
            ...
            "GameCorner": LABEL_DECISION_GAME_CORNER,
            "Route16Encounter": LABEL_DECISION_ROUTE16_ENCOUNTER,
            "Route12Encounter": LABEL_DECISION_ROUTE12_ENCOUNTER,
