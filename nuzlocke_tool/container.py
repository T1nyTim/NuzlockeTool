...
from nuzlocke_tool.data.data_loader import GameDataLoader
from nuzlocke_tool.data.repositories import LocationRepository, MoveRepository, PokemonRepository
from nuzlocke_tool.models.models import GameState
from nuzlocke_tool.services.event_service import EventService
...
class Container(containers.DeclarativeContainer):
    event_manager = providers.Singleton(EventService)
